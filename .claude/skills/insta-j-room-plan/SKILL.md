...
- **이름(검색)**: 제이룸 | 방탈출 후기·추천
- **화자**: 방탈출 400+ "쫄보 4인방" (TEAM.89929495) — 공테(공포테마) 도파민에 빠진 팀
...
| **연방 코스** | 메인 | 높음 | (예정) create-course |
| **소식** | 정기 | 낮~중 (AI 집계) | (예정) create-news |
| **후기** | 비정기 | 중 | (예정) create-review |
...
> **카드2는 카테고리별로 다름**: 추천 = 쫄보 4인방 자기소개(고정) / 소식 = 이번 주 요약.
> 쫄보 브랜딩은 표지 kicker("쫄보 4인방이 모아온/체험한")로 전 카테고리 공통 유지.
...
- ✅ 첫 콘텐츠: **PLAY33 건대 3테마 추천** — 업로드 직전 대기
- 📦 재고(ready): 1개 / 목표 4개
- ⏳ 미정: 발행 시작 시점/빈도 (사용자 검토 중)

> 발행 시작 전 권장: 재고 3~4개 확보 또는 주 1회로 시작 후 확대.
