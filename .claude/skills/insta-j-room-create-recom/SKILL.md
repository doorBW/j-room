...
| 2 | `intro` | **쫄보 4인방 자기소개 (항상 고정 — §3 참고)** |
...
```json
{
  "type": "intro",
  "title": "쫄보 4인방",
  "subtitle": "TEAM.89929495 · 공테 &amp; 문제방에 미쳐가는 중 🔥",
  "points": [
    "<span class=\"accent\">89</span> · 100+ 쫄보, 힘에 밀리면 감 · 인테리어 감탄 전문 1",
    "<span class=\"accent\">92</span> · 30+ 왕쫄보 방린이, 밀어도 안 감 · 인테리어 감탄 전문 2",
    "<span class=\"accent\">94</span> · 100+ 쫄탱, 뼛속까지 이과 똑똑이 🧠",
    "<span class=\"accent\">95</span> · 350+ 쫄탱, 인생 최대 업적 멸탐대 1위 🏆"
  ]
}
```

> 멤버: **89 · 92 · 94 · 95** (팀명 TEAM.89929495). 번호/프로필 바꾸지 말 것.

---

## 4. 톤앤매너 (쫄보 컨셉)

- **화자**: "공테 도파민에 빠진 쫄보 4인방". 친근·과장 위트, 솔직.
